...
class MakeCommand extends BaseGenerator
{
    ...
    public function handle(): int
    {
        ...
        if ($entity) {
            ...
            $handlerBody = $this->buildHandlerBody($crud, $entity, $idType);
        } else {
            $entityImport = '';
    ...
    protected function buildHandlerBody(?string $crud, string $entity, string $idType): string
    {
        $newId = $this->idFactoryCall($idType);

        return match ($crud) {
            'create' => "\$entity = {$entity}::create((string) {$newId});\n        \$this->repository->save(\$entity);",
