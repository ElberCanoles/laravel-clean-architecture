...
{
    protected $signature = 'clean:command {context} {name} {--entity= : Entity name to inject WriteRepository} {--crud= : CRUD operation type (create, update, delete)} {--id-type= : Identifier type generated by create handlers (uuid, ulid)} {--force}';
